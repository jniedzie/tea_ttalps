...
ratio_hist_singleMu.GetXaxis().SetTitleSize(0.05)
ratio_hist_singleMu.GetXaxis().SetLabelSize(0.05)
ratio_hist_singleMu.GetXaxis().SetTitleOffset(1.7)
ratio_hist_singleMu.GetYaxis().SetTitleSize(0.05)
ratio_hist_singleMu.GetYaxis().SetLabelSize(0.05)
