...
input_path = "../datacards/limits_BestPFIsoDimuonVertex_logLxySignificance_vs_log3Dangle_Pat_ABCDpred.txt"
...
def draw_brazil_plot_for_theory_lifetime():
  ...
  limits = helper.get_limits_for_theory_lifetime()
  print(limits)
  ...
  canvas.Update()
  canvas.SaveAs(f"../plots/{input_path.replace('.txt', '')}_theory.pdf")
