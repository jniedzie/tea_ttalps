...
hist_params = {
    # "dEta": (10, 0, 5, 1e-4, 2e0, True),  # check
    # "outerDR": (20, 0, 5, 1e-4, 1e0, True),  # check
    # "vxyzSigma": (100, 0, 20, 1e-4, 1e0, True),  # check
    # "displacedTrackIso04Muon2": (40, 0, 20, 1e-4, 1e0, True),  # check (log x?)

    # "displacedTrackIso03Muon2": (20, 0, 20, 1e-4, 1e0, True),  # check (log x?)
    # "hitsInFrontOfVert1": (1, 0, 10, 1e-2, 1e0, True),
    # "invMass": (200, 0, 80, 1e-4, 1e-1, True),
    ...
    # "dPhi": (10, 0, 2*3.1415, 1e-5, 2e0, True),

    # "dR": (20, -2*3.1415, 2*3.1415, 1e-5, 2e0, True),
    # "eta": (5, -3, 3, 0, 0.2, False),
    # "absPtLxyDPhi1": (20, 0, 3.1415, 1e-6, 2e0, True),
    # "absPtLxyDPhi2": (20, 0, 3.1415, 1e-6, 2e0, True),
...
# hist_params = {
#     # "pt": (5, 0, 50, 1e-5, 2e0, True),
#     # "dxy": (40, -200, 200, 1e-6, 2e0, True),
#     # "dxyPVTrajErr": (5, 0, 50, 1e-6, 2e0, True),
#     # "eta": (10, -3, 3, 1e-4, 2e0, True),
#     # "dz": (40, -200, 200, 1e-6, 2e0, True),
#     # "dzPVErr": (5, 0, 50, 1e-6, 2e0, True),
#     # "normChi2": (100, 0, 4, 1e-5, 1e0, True),
