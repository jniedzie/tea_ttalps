...
samples_params = {
    ...
    "TTToSemiLeptonic"  : {"color": cms_colors[0] , "legend_column": 2, "legend_row": 4, "legend_title": "t#bar{t} semi-leptonic" },
    "TTtoLNu2Q"         : {"color": cms_colors[0] , "legend_column": 2, "legend_row": 4, "legend_title": "t#bar{t} semi-leptonic" },
    
    "TTZToLL"           : {"color": cms_colors[6] , "legend_column": 2, "legend_row": 5, "legend_title": "t#bar{t}Z"              },
    "TTLL"              : {"color": cms_colors[6] , "legend_column": 2, "legend_row": 5, "legend_title": "t#bar{t}Z"              },
    
    "WJets"             : {"color": cms_colors[2] , "legend_column": 1, "legend_row": 0, "legend_title": "W+jets"                 },
    "WtoLNu"            : {"color": cms_colors[2] , "legend_column": 1, "legend_row": 0, "legend_title": "W+jets"                 },
    "TTToHadronic"      : {"color": cms_colors[5] , "legend_column": 1, "legend_row": 1, "legend_title": "t#bar{t} hadronic"      },
    "TTto4Q"            : {"color": cms_colors[5] , "legend_column": 1, "legend_row": 1, "legend_title": "t#bar{t} hadronic"      },
    ...
    "TTZZ"              : {"color": cms_colors[9] , "legend_column": 1, "legend_row": 4, "legend_title": "t#bar{t}ZZ"             },
    "TTZH"              : {"color": cms_colors[0] , "legend_column": 1, "legend_row": 5, "legend_title": "t#bar{t}ZH"             },
    "DYJets"            : {"color": cms_colors[3] , "legend_column": 1, "legend_row": 6, "legend_title": "DY+jets"                },
