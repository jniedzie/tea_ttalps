...
input_output_dirs = (
  ...
  # QCD mu enriched
  # (f"{lovisa_base_path}/backgrounds2018/QCDPt15To20/LLPNanoAOD/",
  #  f"{base_path}/backgrounds2018/QCDPt15To20_LLPnanoAOD/{skim}/"),
  # (f"{lovisa_base_path}/backgrounds2018/QCDPt20To30/LLPNanoAOD/",
  #  f"{base_path}/backgrounds2018/QCDPt20To30_LLPnanoAOD/{skim}/"),
  # (f"{lovisa_base_path}/backgrounds2018/QCDPt30To50/LLPNanoAOD/",
  #  f"{base_path}/backgrounds2018/QCDPt30To50_LLPnanoAOD/{skim}/"),
  # (f"{lovisa_base_path}/backgrounds2018/QCDPt50To80/LLPNanoAOD/",
  #  f"{base_path}/backgrounds2018/QCDPt50To80_LLPnanoAOD/{skim}/"),
  # (f"{lovisa_base_path}/backgrounds2018/QCDPt80To120/LLPNanoAOD/",
  ...
  # (f"{lovisa_base_path}/backgrounds2018/QCDPt600To800/LLPNanoAOD/",
  #  f"{base_path}/backgrounds2018/QCDPt600To800_LLPnanoAOD/{skim}/"),
  # (f"{lovisa_base_path}/backgrounds2018/QCDPt800To1000/LLPNanoAOD/",
  #  f"{base_path}/backgrounds2018/QCDPt800To1000_LLPnanoAOD/{skim}/"),
  # (f"{lovisa_base_path}/backgrounds2018/QCDPt1000/LLPNanoAOD/",
  #  f"{base_path}/backgrounds2018/QCDPt1000_LLPnanoAOD/{skim}/"),
  
  # Signals
  # (f"{lovisa_base_path}/signals/tta_mAlp-0p35GeV_ctau-1e0mm_nEvents-100/LLPNanoAOD/",
  #  f"{base_path}/signals/tta_mAlp-0p35GeV_ctau-1e0mm/{skim}/"),
  # (f"{lovisa_base_path}/signals/tta_mAlp-0p35GeV_ctau-1e1mm_nEvents-100/LLPNanoAOD/",
  #  f"{base_path}/signals/tta_mAlp-0p35GeV_ctau-1e1mm/{skim}/"),
  # (f"{lovisa_base_path}/signals/tta_mAlp-0p35GeV_ctau-1e2mm_nEvents-100/LLPNanoAOD/",
  #  f"{base_path}/signals/tta_mAlp-0p35GeV_ctau-1e2mm/{skim}/"),
  # (f"{lovisa_base_path}/signals/tta_mAlp-0p35GeV_ctau-1e3mm_nEvents-100/LLPNanoAOD/",
  #  f"{base_path}/signals/tta_mAlp-0p35GeV_ctau-1e3mm/{skim}/"),
  # (f"{lovisa_base_path}/signals/tta_mAlp-0p35GeV_ctau-1e5mm_nEvents-1000/LLPNanoAOD/",
