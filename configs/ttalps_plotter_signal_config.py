...
output_path = f"../plots/{skim.replace('skimmed_', '')}_{hist_path.replace('histograms_', '').replace('histograms', '')}_{sampletype}_fix/"
...
#           name                                  title logy    norm_type                 rebin xmin   xmax    ymin    ymax,   xlabel                                             ylabel
  ...
  # Histogram("LooseMuonsDRMatch_pt"           , "", False, True  , default_norm              , 20 , 0     , 500   , 1e-1  , 1e6   , "loose #mu p_{T} [GeV]"                          , "# events (2018)"   ),
  # Histogram("LooseMuonsDRMatch_eta"          , "", False, True  , default_norm              , 10 , -3    , 3     , 1e-1*y_scale   , 1e8*y_scale   , "loose #mu #eta"                , "# events (2018)"   ),
  # Histogram("LooseMuonsDRMatch_dxy"          , "", False, True  , default_norm              , 20 , -200  , 200   , 1e-1  , 1e8   , "loose #mu d_{xy} [cm]"                          , "# events (2018)"   ),
  # Histogram("LooseMuonsDRMatch_dxyPVTraj"    , "", False, True  , default_norm              , 20 , -100  , 100   , 1e-1  , 1e8   , "loose #mu d_{xy} [cm]"                          , "# events (2018)"   ),
  # Histogram("LooseMuonsDRMatch_dxyPVTrajErr" , "", False, True  , default_norm              , 20 , 0     , 200   , 1e-1  , 1e8   , "loose #mu d_{xy} uncertainty [cm]"              , "# events (2018)"   ),
  # Histogram("LooseMuonsDRMatch_dxyPVTrajSig" , "", False, True  , default_norm              , 20 , 0     , 200   , 1e-1  , 1e8   , "loose #mu d_{xy} significance"                  , "# events (2018)"   ),
  # Histogram("LooseMuonsDRMatch_dz"           , "", False, True  , default_norm              , 20 , -200  , 200   , 1e-1  , 1e8   , "loose #mu d_{z} [cm]"                           , "# events (2018)"   ),
  # Histogram("LooseMuonsDRMatch_dzPV"         , "", False, True  , default_norm              , 20 , -200  , 200   , 1e-1  , 1e8   , "loose #mu d_{z} [cm]"                           , "# events (2018)"   ),
  # Histogram("LooseMuonsDRMatch_dzPVErr"      , "", False, True  , default_norm              , 20 , 0     , 200   , 1e-1  , 1e8   , "loose #mu d_{z} uncertainty [cm]"               , "# events (2018)"   ),
  # Histogram("LooseMuonsDRMatch_dzPVSig"      , "", False, True  , default_norm              , 20 , 0     , 200   , 1e-1  , 1e8   , "loose #mu d_{z} significance"                   , "# events (2018)"   ),
  # Histogram("LooseMuonsDRMatch_ip3DPVSigned"    , "", False, True  , default_norm           , 100, -500  , 500   , 1e-1  , 1e8   , "loose #mu 3D IP [cm]"                           , "# events (2018)"   ),
  # Histogram("LooseMuonsDRMatch_ip3DPVSignedErr" , "", False, True  , default_norm           , 20 , 0     , 200   , 1e-1  , 1e8   , "loose #mu 3D IP uncertainty [cm]"               , "# events (2018)"   ),
  # Histogram("LooseMuonsDRMatch_ip3DPVSignedSig" , "", False, True  , default_norm           , 20 , 0     , 200   , 1e-1  , 1e8   , "loose #mu 3D IP significance"                   , "# events (2018)"   ),
  # Histogram("LooseMuonsDRMatch_minDeltaR"       , "", False, True  , default_norm              , 20 , 0     , 200   , 1e-1  , 1e8   , "min #Deta R(loose #mu, loose #mu)"              , "# events (2018)"   ),
  # Histogram("LooseMuonsDRMatch_minOuterDeltaR"  , "", False, True  , default_norm              , 20 , 0     , 200   , 1e-1  , 1e8   , "min outer #Deta R(loose #mu, loose #mu)"        , "# events (2018)"   ),
  # Histogram("LooseMuonsDRMatch_minProxDeltaR"   , "", False, True  , default_norm              , 20 , 0     , 200   , 1e-1  , 1e8   , "min proximity #Deta R(loose #mu, loose #mu)"    , "# events (2018)"   ),
  ...
  Histogram("LooseMuonsOuterDRMatch_pt"              , "", False, True  , default_norm              , 20 , 0     , 500   , 1e-1  , 1e5   , "loose #mu p_{T} [GeV]"                          , "# events (2018)"   ),
  Histogram("LooseMuonsOuterDRMatch_eta"             , "", False, True  , default_norm              , 10 , -3    , 3     , 1e-1   , 1e7   , "loose #mu #eta"                                 , "# events (2018)"   ),
  Histogram("LooseMuonsOuterDRMatch_dxy"             , "", False, True  , default_norm              , 20 , -200  , 200   , 1e-1  , 1e8   , "loose #mu d_{xy} [cm]"                          , "# events (2018)"   ),
  Histogram("LooseMuonsOuterDRMatch_dxyPVTraj"       , "", False, True  , default_norm              , 100 , -300  , 300   , 1e-3  , 1e6   , "loose #mu d_{xy} [cm]"                          , "# events (2018)"   ),
  Histogram("LooseMuonsOuterDRMatch_dxyPVTrajErr"    , "", False, True  , default_norm              , 20 , 0     , 200   , 1e-1  , 1e8   , "loose #mu d_{xy} uncertainty [cm]"              , "# events (2018)"   ),
  Histogram("LooseMuonsOuterDRMatch_dxyPVTrajSig"    , "", False, True  , default_norm              , 20 , 0     , 200   , 1e-1  , 1e8   , "loose #mu d_{xy} significance"                  , "# events (2018)"   ),
  Histogram("LooseMuonsOuterDRMatch_dz"              , "", False, True  , default_norm              , 20 , -200  , 200   , 1e-1  , 1e8   , "loose #mu d_{z} [cm]"                           , "# events (2018)"   ),
  Histogram("LooseMuonsOuterDRMatch_dzPV"            , "", False, True  , default_norm              , 20 , -200  , 200   , 1e-1  , 1e8   , "loose #mu d_{z} [cm]"                           , "# events (2018)"   ),
  Histogram("LooseMuonsOuterDRMatch_dzPVErr"         , "", False, True  , default_norm              , 20 , 0     , 200   , 1e-1  , 1e8   , "loose #mu d_{z} uncertainty [cm]"               , "# events (2018)"   ),
  Histogram("LooseMuonsOuterDRMatch_dzPVSig"         , "", False, True  , default_norm              , 20 , 0     , 200   , 1e-1  , 1e8   , "loose #mu d_{z} significance"                   , "# events (2018)"   ),
  Histogram("LooseMuonsOuterDRMatch_ip3DPVSigned"    , "", False, True  , default_norm              , 250, -600  , 600   , 1e-3  , 1e6   , "loose #mu 3D IP [cm]"                           , "# events (2018)"   ),
  Histogram("LooseMuonsOuterDRMatch_ip3DPVSignedErr" , "", False, True  , default_norm              , 20 , 0     , 200   , 1e-1  , 1e8   , "loose #mu 3D IP uncertainty [cm]"               , "# events (2018)"   ),
  Histogram("LooseMuonsOuterDRMatch_ip3DPVSignedSig" , "", False, True  , default_norm              , 20 , 0     , 200   , 1e-1  , 1e8   , "loose #mu 3D IP significance"                   , "# events (2018)"   ),
  Histogram("LooseMuonsOuterDRMatch_minDeltaR"       , "", False, True  , default_norm              , 20 , 0     , 200   , 1e-1  , 1e8   , "min #Deta R(loose #mu, loose #mu)"              , "# events (2018)"   ),
  Histogram("LooseMuonsOuterDRMatch_minOuterDeltaR"  , "", False, True  , default_norm              , 20 , 0     , 200   , 1e-1  , 1e8   , "min outer #Deta R(loose #mu, loose #mu)"        , "# events (2018)"   ),
  Histogram("LooseMuonsOuterDRMatch_minProxDeltaR"   , "", False, True  , default_norm              , 20 , 0     , 200   , 1e-1  , 1e8   , "min proximity #Deta R(loose #mu, loose #mu)"    , "# events (2018)"   ),
  Histogram("Event_nLoosePATMuonsOuterDRMatch"       , "", False, True  , default_norm              , 1  , 0     , 15    , 1e-2*y_scale   , 1e9*y_scale   , "Number of loose Pat #mu"       , "# events (2018)"   ),
  Histogram("LoosePATMuonsOuterDRMatch_pt"           , "", False, True  , default_norm              , 20 , 0     , 500   , 1e-1  , 1e5   , "loose #mu p_{T} [GeV]"                          , "# events (2018)"   ),
  Histogram("LoosePATMuonsOuterDRMatch_eta"          , "", False, True  , default_norm              , 10 , -3    , 3     , 1e-1   , 1e7   , "loose #mu #eta"                                 , "# events (2018)"   ),
  Histogram("LoosePATMuonsOuterDRMatch_dxy"          , "", False, True  , default_norm              , 20 , -200  , 200   , 1e-1  , 1e8   , "loose #mu d_{xy} [cm]"                          , "# events (2018)"   ),
  Histogram("LoosePATMuonsOuterDRMatch_dxyPVTraj"    , "", False, True  , default_norm              , 20 , -100  , 100   , 1e-3  , 1e6   , "loose #mu d_{xy} [cm]"                          , "# events (2018)"   ),
  Histogram("LoosePATMuonsOuterDRMatch_dxyPVTrajErr" , "", False, True  , default_norm              , 20 , 0     , 200   , 1e-1  , 1e8   , "loose #mu d_{xy} uncertainty [cm]"              , "# events (2018)"   ),
  Histogram("LoosePATMuonsOuterDRMatch_dxyPVTrajSig" , "", False, True  , default_norm              , 20 , 0     , 200   , 1e-1  , 1e8   , "loose #mu d_{xy} significance"                  , "# events (2018)"   ),
  Histogram("LoosePATMuonsOuterDRMatch_dz"           , "", False, True  , default_norm              , 20 , -200  , 200   , 1e-1  , 1e8   , "loose #mu d_{z} [cm]"                           , "# events (2018)"   ),
  Histogram("LoosePATMuonsOuterDRMatch_dzPV"         , "", False, True  , default_norm              , 20 , -200  , 200   , 1e-1  , 1e8   , "loose #mu d_{z} [cm]"                           , "# events (2018)"   ),
  Histogram("LoosePATMuonsOuterDRMatch_dzPVErr"      , "", False, True  , default_norm              , 20 , 0     , 200   , 1e-1  , 1e8   , "loose #mu d_{z} uncertainty [cm]"               , "# events (2018)"   ),
  Histogram("LoosePATMuonsOuterDRMatch_dzPVSig"      , "", False, True  , default_norm              , 20 , 0     , 200   , 1e-1  , 1e8   , "loose #mu d_{z} significance"                   , "# events (2018)"   ),
  Histogram("LoosePATMuonsOuterDRMatch_ip3DPVSigned"    , "", False, True  , default_norm           , 100, -500  , 500   , 1e-3  , 1e6   , "loose #mu 3D IP [cm]"                           , "# events (2018)"   ),
  Histogram("LoosePATMuonsOuterDRMatch_ip3DPVSignedErr" , "", False, True  , default_norm           , 20 , 0     , 200   , 1e-1  , 1e8   , "loose #mu 3D IP uncertainty [cm]"               , "# events (2018)"   ),
  Histogram("LoosePATMuonsOuterDRMatch_ip3DPVSignedSig" , "", False, True  , default_norm           , 20 , 0     , 200   , 1e-1  , 1e8   , "loose #mu 3D IP significance"                   , "# events (2018)"   ),
  Histogram("Event_nLooseDSAMuonsOuterDRMatch"       , "", False, True  , default_norm              , 1  , 0     , 15    , 1e-2*y_scale   , 1e9*y_scale   , "Number of loose DSA #mu"                            , "# events (2018)"   ),
  Histogram("LooseDSAMuonsOuterDRMatch_pt"           , "", False, True  , default_norm              , 20 , 0     , 500   , 1e-1  , 1e5   , "loose #mu p_{T} [GeV]"                          , "# events (2018)"   ),
  Histogram("LooseDSAMuonsOuterDRMatch_eta"          , "", False, True  , default_norm              , 10 , -3    , 3     , 1e-1   , 1e7   , "loose #mu #eta"                                 , "# events (2018)"   ),
  Histogram("LooseDSAMuonsOuterDRMatch_dxy"          , "", False, True  , default_norm              , 20 , -200  , 200   , 1e-1  , 1e8   , "loose #mu d_{xy} [cm]"                          , "# events (2018)"   ),
  Histogram("LooseDSAMuonsOuterDRMatch_dxyPVTraj"    , "", False, True  , default_norm              , 20 , -100  , 100   , 1e-3  , 1e6   , "loose #mu d_{xy} [cm]"                          , "# events (2018)"   ),
  Histogram("LooseDSAMuonsOuterDRMatch_dxyPVTrajErr" , "", False, True  , default_norm              , 20 , 0     , 200   , 1e-1  , 1e8   , "loose #mu d_{xy} uncertainty [cm]"              , "# events (2018)"   ),
  Histogram("LooseDSAMuonsOuterDRMatch_dxyPVTrajSig" , "", False, True  , default_norm              , 20 , 0     , 200   , 1e-1  , 1e8   , "loose #mu d_{xy} significance"                  , "# events (2018)"   ),
  Histogram("LooseDSAMuonsOuterDRMatch_dz"           , "", False, True  , default_norm              , 20 , -200  , 200   , 1e-1  , 1e8   , "loose #mu d_{z} [cm]"                           , "# events (2018)"   ),
  Histogram("LooseDSAMuonsOuterDRMatch_dzPV"         , "", False, True  , default_norm              , 20 , -200  , 200   , 1e-1  , 1e8   , "loose #mu d_{z} [cm]"                           , "# events (2018)"   ),
  Histogram("LooseDSAMuonsOuterDRMatch_dzPVErr"      , "", False, True  , default_norm              , 20 , 0     , 200   , 1e-1  , 1e8   , "loose #mu d_{z} uncertainty [cm]"               , "# events (2018)"   ),
  Histogram("LooseDSAMuonsOuterDRMatch_dzPVSig"      , "", False, True  , default_norm              , 20 , 0     , 200   , 1e-1  , 1e8   , "loose #mu d_{z} significance"                   , "# events (2018)"   ),
  Histogram("LooseDSAMuonsOuterDRMatch_ip3DPVSigned"    , "", False, True  , default_norm           , 100, -500  , 500   , 1e-3  , 1e6   , "loose #mu 3D IP [cm]"                           , "# events (2018)"   ),
  Histogram("LooseDSAMuonsOuterDRMatch_ip3DPVSignedErr" , "", False, True  , default_norm           , 20 , 0     , 200   , 1e-1  , 1e8   , "loose #mu 3D IP uncertainty [cm]"               , "# events (2018)"   ),
  Histogram("LooseDSAMuonsOuterDRMatch_ip3DPVSignedSig" , "", False, True  , default_norm           , 20 , 0     , 200   , 1e-1  , 1e8   , "loose #mu 3D IP significance"                   , "# events (2018)"   ),
  ...
  Histogram("LooseMuonsSegmentMatch_pt"           , "", False, True  , default_norm                 , 20 , 0     , 500   , 1e-1  , 1e5   , "loose #mu p_{T} [GeV]"                          , "# events (2018)"   ),
  Histogram("LooseMuonsSegmentMatch_eta"          , "", False, True  , default_norm                 , 10 , -3    , 3     , 1e-1  , 1e7   , "loose #mu #eta"                                 , "# events (2018)"   ),
  Histogram("LooseMuonsSegmentMatch_dxy"          , "", False, True  , default_norm                 , 20 , -200  , 200   , 1e-1  , 1e8   , "loose #mu d_{xy} [cm]"                          , "# events (2018)"   ),
  Histogram("LooseMuonsSegmentMatch_dxyPVTraj"    , "", False, True  , default_norm                 , 100, -300  , 300   , 1e-3  , 1e6   , "loose #mu d_{xy} [cm]"                          , "# events (2018)"   ),
  Histogram("LooseMuonsSegmentMatch_dxyPVTrajErr" , "", False, True  , default_norm                 , 20 , 0     , 200   , 1e-1  , 1e8   , "loose #mu d_{xy} uncertainty [cm]"              , "# events (2018)"   ),
  Histogram("LooseMuonsSegmentMatch_dxyPVTrajSig" , "", False, True  , default_norm                 , 20 , 0     , 200   , 1e-1  , 1e8   , "loose #mu d_{xy} significance"                  , "# events (2018)"   ),
  Histogram("LooseMuonsSegmentMatch_dz"           , "", False, True  , default_norm                 , 20 , -200  , 200   , 1e-1  , 1e8   , "loose #mu d_{z} [cm]"                           , "# events (2018)"   ),
  Histogram("LooseMuonsSegmentMatch_dzPV"         , "", False, True  , default_norm                 , 20 , -200  , 200   , 1e-1  , 1e8   , "loose #mu d_{z} [cm]"                           , "# events (2018)"   ),
  Histogram("LooseMuonsSegmentMatch_dzPVErr"      , "", False, True  , default_norm                 , 20 , 0     , 200   , 1e-1  , 1e8   , "loose #mu d_{z} uncertainty [cm]"               , "# events (2018)"   ),
  Histogram("LooseMuonsSegmentMatch_dzPVSig"      , "", False, True  , default_norm                 , 20 , 0     , 200   , 1e-1  , 1e8   , "loose #mu d_{z} significance"                   , "# events (2018)"   ),
  Histogram("LooseMuonsSegmentMatch_ip3DPVSigned"    , "", False, True  , default_norm              , 250, -600  , 600   , 1e-3  , 1e6   , "loose #mu 3D IP [cm]"                           , "# events (2018)"   ),
  Histogram("LooseMuonsSegmentMatch_ip3DPVSignedErr" , "", False, True  , default_norm              , 20 , 0     , 200   , 1e-1  , 1e8   , "loose #mu 3D IP uncertainty [cm]"               , "# events (2018)"   ),
  Histogram("LooseMuonsSegmentMatch_ip3DPVSignedSig" , "", False, True  , default_norm              , 20 , 0     , 200   , 1e-1  , 1e8   , "loose #mu 3D IP significance"                   , "# events (2018)"   ),
  Histogram("LooseMuonsSegmentMatch_minDeltaR"       , "", False, True  , default_norm              , 20 , 0     , 200   , 1e-1  , 1e8   , "min #Deta R(loose #mu, loose #mu)"              , "# events (2018)"   ),
  Histogram("LooseMuonsSegmentMatch_minOuterDeltaR"  , "", False, True  , default_norm              , 20 , 0     , 200   , 1e-1  , 1e8   , "min outer #Deta R(loose #mu, loose #mu)"        , "# events (2018)"   ),
  Histogram("LooseMuonsSegmentMatch_minProxDeltaR"   , "", False, True  , default_norm              , 20 , 0     , 200   , 1e-1  , 1e8   , "min proximity #Deta R(loose #mu, loose #mu)"    , "# events (2018)"   ),
  Histogram("Event_nLoosePATMuonsSegmentMatch"       , "", False, True  , default_norm              , 1  , 0     , 15    , 1e-2*y_scale   , 1e9*y_scale   , "Number of loose Pat #mu"       , "# events (2018)"   ),
  Histogram("LoosePATMuonsSegmentMatch_pt"           , "", False, True  , default_norm              , 20 , 0     , 500   , 1e-1  , 1e5   , "loose #mu p_{T} [GeV]"                          , "# events (2018)"   ),
  Histogram("LoosePATMuonsSegmentMatch_eta"          , "", False, True  , default_norm              , 10 , -3    , 3     , 1e-1   , 1e7   , "loose #mu #eta"                                 , "# events (2018)"   ),
  Histogram("LoosePATMuonsSegmentMatch_dxy"          , "", False, True  , default_norm              , 20 , -200  , 200   , 1e-1  , 1e8   , "loose #mu d_{xy} [cm]"                          , "# events (2018)"   ),
  Histogram("LoosePATMuonsSegmentMatch_dxyPVTraj"    , "", False, True  , default_norm              , 20 , -100  , 100   , 1e-3  , 1e6   , "loose #mu d_{xy} [cm]"                          , "# events (2018)"   ),
  Histogram("LoosePATMuonsSegmentMatch_dxyPVTrajErr" , "", False, True  , default_norm              , 20 , 0     , 200   , 1e-1  , 1e8   , "loose #mu d_{xy} uncertainty [cm]"              , "# events (2018)"   ),
  Histogram("LoosePATMuonsSegmentMatch_dxyPVTrajSig" , "", False, True  , default_norm              , 20 , 0     , 200   , 1e-1  , 1e8   , "loose #mu d_{xy} significance"                  , "# events (2018)"   ),
  Histogram("LoosePATMuonsSegmentMatch_dz"           , "", False, True  , default_norm              , 20 , -200  , 200   , 1e-1  , 1e8   , "loose #mu d_{z} [cm]"                           , "# events (2018)"   ),
  Histogram("LoosePATMuonsSegmentMatch_dzPV"         , "", False, True  , default_norm              , 20 , -200  , 200   , 1e-1  , 1e8   , "loose #mu d_{z} [cm]"                           , "# events (2018)"   ),
  Histogram("LoosePATMuonsSegmentMatch_dzPVErr"      , "", False, True  , default_norm              , 20 , 0     , 200   , 1e-1  , 1e8   , "loose #mu d_{z} uncertainty [cm]"               , "# events (2018)"   ),
  Histogram("LoosePATMuonsSegmentMatch_dzPVSig"      , "", False, True  , default_norm              , 20 , 0     , 200   , 1e-1  , 1e8   , "loose #mu d_{z} significance"                   , "# events (2018)"   ),
  Histogram("LoosePATMuonsSegmentMatch_ip3DPVSigned"    , "", False, True  , default_norm           , 100, -500  , 500   , 1e-3  , 1e6   , "loose #mu 3D IP [cm]"                           , "# events (2018)"   ),
  Histogram("LoosePATMuonsSegmentMatch_ip3DPVSignedErr" , "", False, True  , default_norm           , 20 , 0     , 200   , 1e-1  , 1e8   , "loose #mu 3D IP uncertainty [cm]"               , "# events (2018)"   ),
  Histogram("LoosePATMuonsSegmentMatch_ip3DPVSignedSig" , "", False, True  , default_norm           , 20 , 0     , 200   , 1e-1  , 1e8   , "loose #mu 3D IP significance"                   , "# events (2018)"   ),
  Histogram("Event_nLooseDSAMuonsSegmentMatch"       , "", False, True  , default_norm              , 1  , 0     , 15    , 1e-2*y_scale   , 1e9*y_scale   , "Number of loose DSA #mu"                            , "# events (2018)"   ),
  Histogram("LooseDSAMuonsSegmentMatch_pt"           , "", False, True  , default_norm              , 20 , 0     , 500   , 1e-1  , 1e5   , "loose #mu p_{T} [GeV]"                          , "# events (2018)"   ),
  Histogram("LooseDSAMuonsSegmentMatch_eta"          , "", False, True  , default_norm              , 10 , -3    , 3     , 1e-1   , 1e7   , "loose #mu #eta"                                 , "# events (2018)"   ),
  Histogram("LooseDSAMuonsSegmentMatch_dxy"          , "", False, True  , default_norm              , 20 , -200  , 200   , 1e-1  , 1e8   , "loose #mu d_{xy} [cm]"                          , "# events (2018)"   ),
  Histogram("LooseDSAMuonsSegmentMatch_dxyPVTraj"    , "", False, True  , default_norm              , 20 , -100  , 100   , 1e-3  , 1e6   , "loose #mu d_{xy} [cm]"                          , "# events (2018)"   ),
  Histogram("LooseDSAMuonsSegmentMatch_dxyPVTrajErr" , "", False, True  , default_norm              , 20 , 0     , 200   , 1e-1  , 1e8   , "loose #mu d_{xy} uncertainty [cm]"              , "# events (2018)"   ),
  Histogram("LooseDSAMuonsSegmentMatch_dxyPVTrajSig" , "", False, True  , default_norm              , 20 , 0     , 200   , 1e-1  , 1e8   , "loose #mu d_{xy} significance"                  , "# events (2018)"   ),
  Histogram("LooseDSAMuonsSegmentMatch_dz"           , "", False, True  , default_norm              , 20 , -200  , 200   , 1e-1  , 1e8   , "loose #mu d_{z} [cm]"                           , "# events (2018)"   ),
  Histogram("LooseDSAMuonsSegmentMatch_dzPV"         , "", False, True  , default_norm              , 20 , -200  , 200   , 1e-1  , 1e8   , "loose #mu d_{z} [cm]"                           , "# events (2018)"   ),
  Histogram("LooseDSAMuonsSegmentMatch_dzPVErr"      , "", False, True  , default_norm              , 20 , 0     , 200   , 1e-1  , 1e8   , "loose #mu d_{z} uncertainty [cm]"               , "# events (2018)"   ),
  Histogram("LooseDSAMuonsSegmentMatch_dzPVSig"      , "", False, True  , default_norm              , 20 , 0     , 200   , 1e-1  , 1e8   , "loose #mu d_{z} significance"                   , "# events (2018)"   ),
  Histogram("LooseDSAMuonsSegmentMatch_ip3DPVSigned"    , "", False, True  , default_norm           , 100, -500  , 500   , 1e-3  , 1e6   , "loose #mu 3D IP [cm]"                           , "# events (2018)"   ),
  Histogram("LooseDSAMuonsSegmentMatch_ip3DPVSignedErr" , "", False, True  , default_norm           , 20 , 0     , 200   , 1e-1  , 1e8   , "loose #mu 3D IP uncertainty [cm]"               , "# events (2018)"   ),
  Histogram("LooseDSAMuonsSegmentMatch_ip3DPVSignedSig" , "", False, True  , default_norm           , 20 , 0     , 200   , 1e-1  , 1e8   , "loose #mu 3D IP significance"                   , "# events (2018)"   ),
  ...
  # Histogram("LooseMuonsVertexDRMatch_proxDR"         , "", False, True  , default_norm              , 1  , 0     , 10    , 1e-1  , 1e8   , "Pat #mu vertex #Delta R"                        , "# events (2018)"   ),
  ...
  # Histogram("Event_nLooseMuonsVertexOuterDRMatch"    , "", False, True  , default_norm              , 1  , 0     , 20    , 1e1   , 1e6   , "Number of #mu vertices"                 , "# events (2018)"   ),
  # Histogram("LooseMuonsVertexOuterDRMatch_vxy"       , "", False, True  , default_norm              , 100 , 0     , 700   , 1e0   , 1e8   , "#mu vertex v_{xy} [cm]"                     , "# events (2018)"   ),
  # Histogram("LooseMuonsVertexOuterDRMatch_vxySigma"  , "", False, True  , default_norm              , 2  , 0     , 100   , 1e-1  , 1e8   , "#mu vertex #sigma_{v_{xy}} [cm]"            , "# events (2018)"   ),
  # Histogram("LooseMuonsVertexOuterDRMatch_vx"        , "", False, True  , default_norm              , 10 , -600  , 600   , 1e0   , 1e8   , "#mu vertex v_{x} [cm]"                      , "# events (2018)"   ),
  # Histogram("LooseMuonsVertexOuterDRMatch_vy"        , "", False, True  , default_norm              , 10 , -600  , 600   , 1e0   , 1e8   , "#mu vertex v_{y} [cm]"                      , "# events (2018)"   ),
  # Histogram("LooseMuonsVertexOuterDRMatch_vz"        , "", False, True  , default_norm              , 20 , -600  , 600   , 1e-1  , 1e8   , "#mu vertex v_{z} [cm]"                      , "# events (2018)"   ),
  # Histogram("LooseMuonsVertexOuterDRMatch_vxyz"      , "", False, True  , default_norm              , 100 , 0     , 1000   , 1e-1  , 1e8   , "#mu vertex v_{xyz} [cm]"                    , "# events (2018)"   ),
  # Histogram("LooseMuonsVertexOuterDRMatch_dR"        , "", False, True  , default_norm              , 1  , 0     , 1     , 1e-1  , 1e8   , "#mu vertex #Delta R"                        , "# events (2018)"   ),
  # Histogram("LooseMuonsVertexOuterDRMatch_proxDR"    , "", False, True  , default_norm              , 1  , 0     , 1     , 1e-1  , 1e8   , "#mu vertex #Delta R"                        , "# events (2018)"   ),
  # Histogram("LooseMuonsVertexOuterDRMatch_chi2"      , "", False, True  , default_norm              , 10 , 0     , 500   , 1e-1  , 1e8   , "#mu vertex #chi^{2}"                        , "# events (2018)"   ),
  ...
  # Histogram("Event_nLooseMuonsVertexOuterDRMatch_PatDSA"               , "", False, True  , default_norm        , 1  , 0     , 20    , 1e1   , 1e6   , "Number of PAT-DSA #mu vertices"                 , "# events (2018)"   ),
  # Histogram("LooseMuonsVertexOuterDRMatch_vxy_PatDSA"                  , "", False, True  , default_norm        , 10 , 0     , 600   , 1e0   , 1e8   , "PAT-DSA #mu vertex v_{xy} [cm]"                 , "# events (2018)"   ),
  # Histogram("LooseMuonsVertexOuterDRMatch_vxySigma_PatDSA"             , "", False, True  , default_norm        , 2  , 0     , 100   , 1e-1  , 1e8   , "PAT-DSA #mu vertex #sigma_{v_{xy}} [cm]"        , "# events (2018)"   ),
  # Histogram("LooseMuonsVertexOuterDRMatch_vx_PatDSA"                   , "", False, True  , default_norm        , 10 , -600  , 600   , 1e0   , 1e8   , "PAT-DSA #mu vertex v_{x} [cm]"                  , "# events (2018)"   ),
  # Histogram("LooseMuonsVertexOuterDRMatch_vy_PatDSA"                   , "", False, True  , default_norm        , 10 , -600  , 600   , 1e0   , 1e8   , "PAT-DSA #mu vertex v_{y} [cm]"                  , "# events (2018)"   ),
  # Histogram("LooseMuonsVertexOuterDRMatch_vz_PatDSA"                   , "", False, True  , default_norm        , 20 , -600  , 600   , 1e-1  , 1e8   , "PAT-DSA #mu vertex v_{z} [cm]"                  , "# events (2018)"   ),
  # Histogram("LooseMuonsVertexOuterDRMatch_vxyz_PatDSA"                 , "", False, True  , default_norm        , 20 , 0     , 800   , 1e-1  , 1e8   , "PAT-DSA #mu vertex v_{xyz} [cm]"                , "# events (2018)"   ),
  # Histogram("LooseMuonsVertexOuterDRMatch_dR_PatDSA"                   , "", False, True  , default_norm        , 1  , 0     , 10    , 1e-1  , 1e8   , "PAT-DSA #mu vertex #Delta R"                    , "# events (2018)"   ),
  # Histogram("LooseMuonsVertexOuterDRMatch_chi2_PatDSA"                 , "", False, True  , default_norm        , 10 , 0     , 500   , 1e-1  , 1e8   , "PAT-DSA #mu vertex #chi^{2}"                    , "# events (2018)"   ),
  # Histogram("Event_nLooseMuonsVertexOuterDRMatch_Pat"                  , "", False, True  , default_norm        , 1  , 0     , 20    , 1e1   , 1e6   , "Number of PAT-DSA #mu vertices"                 , "# events (2018)"   ),
  # Histogram("LooseMuonsVertexOuterDRMatch_vxy_Pat"                     , "", False, True  , default_norm        , 10 , 0     , 600   , 1e0   , 1e8   , "PAT #mu vertex v_{xy} [cm]"                     , "# events (2018)"   ),
  # Histogram("LooseMuonsVertexOuterDRMatch_vxySigma_Pat"                , "", False, True  , default_norm        , 2  , 0     , 100   , 1e-1  , 1e8   , "PAT #mu vertex #sigma_{v_{xy}} [cm]"            , "# events (2018)"   ),
  # Histogram("LooseMuonsVertexOuterDRMatch_vx_Pat"                      , "", False, True  , default_norm        , 10 , -600  , 600   , 1e0   , 1e8   , "PAT #mu vertex v_{x} [cm]"                      , "# events (2018)"   ),
  # Histogram("LooseMuonsVertexOuterDRMatch_vy_Pat"                      , "", False, True  , default_norm        , 10 , -600  , 600   , 1e0   , 1e8   , "PAT #mu vertex v_{y} [cm]"                      , "# events (2018)"   ),
  # Histogram("LooseMuonsVertexOuterDRMatch_vz_Pat"                      , "", False, True  , default_norm        , 20 , -600  , 600   , 1e-1  , 1e8   , "PAT #mu vertex v_{z} [cm]"                      , "# events (2018)"   ),
  # Histogram("LooseMuonsVertexOuterDRMatch_vxyz_Pat"                    , "", False, True  , default_norm        , 20 , 0     , 800   , 1e-1  , 1e8   , "PAT #mu vertex v_{xyz} [cm]"                    , "# events (2018)"   ),
  # Histogram("LooseMuonsVertexOuterDRMatch_dR_Pat"                      , "", False, True  , default_norm        , 1  , 0     , 10    , 1e-1  , 1e8   , "PAT #mu vertex #Delta R"                        , "# events (2018)"   ),
  # Histogram("LooseMuonsVertexOuterDRMatch_chi2_Pat"                    , "", False, True  , default_norm        , 10 , 0     , 500   , 1e-1  , 1e8   , "PAT #mu vertex #chi^{2}"                        , "# events (2018)"   ),
  # Histogram("Event_nLooseMuonsVertexOuterDRMatch_DSA"                  , "", False, True  , default_norm        , 1  , 0     , 20    , 1e1   , 1e6   , "Number of PAT-DSA #mu vertices"                 , "# events (2018)"   ),
  # Histogram("LooseMuonsVertexOuterDRMatch_vxy_DSA"                     , "", False, True  , default_norm        , 10 , 0     , 600   , 1e0   , 1e8   , "DSA #mu vertex v_{xy} [cm]"                     , "# events (2018)"   ),
  # Histogram("LooseMuonsVertexOuterDRMatch_vxySigma_DSA"                , "", False, True  , default_norm        , 2  , 0     , 100   , 1e-1  , 1e8   , "DSA #mu vertex #sigma_{v_{xy}} [cm]"            , "# events (2018)"   ),
  # Histogram("LooseMuonsVertexOuterDRMatch_vx_DSA"                      , "", False, True  , default_norm        , 10 , -600  , 600   , 1e0   , 1e8   , "DSA #mu vertex v_{x} [cm]"                      , "# events (2018)"   ),
  # Histogram("LooseMuonsVertexOuterDRMatch_vy_DSA"                      , "", False, True  , default_norm        , 10 , -600  , 600   , 1e0   , 1e8   , "DSA #mu vertex v_{y} [cm]"                      , "# events (2018)"   ),
  # Histogram("LooseMuonsVertexOuterDRMatch_vz_DSA"                      , "", False, True  , default_norm        , 20 , -600  , 600   , 1e-1  , 1e8   , "DSA #mu vertex v_{z} [cm]"                      , "# events (2018)"   ),
  # Histogram("LooseMuonsVertexOuterDRMatch_vxyz_DSA"                    , "", False, True  , default_norm        , 20 , 0     , 800   , 1e-1  , 1e8   , "DSA #mu vertex v_{xyz} [cm]"                    , "# events (2018)"   ),
  # Histogram("LooseMuonsVertexOuterDRMatch_dR_DSA"                      , "", False, True  , default_norm        , 1  , 0     , 10    , 1e-1  , 1e8   , "DSA #mu vertex #Delta R"                        , "# events (2018)"   ),
  # Histogram("LooseMuonsVertexOuterDRMatch_chi2_DSA"                    , "", False, True  , default_norm        , 10 , 0     , 500   , 1e-1  , 1e8   , "DSA #mu vertex #chi^{2}"                        , "# events (2018)"   ),
  ...
  Histogram("LooseMuonsVertexSegmentMatch_vx"        , "", False, True  , default_norm              , 10 , -600  , 600   , 1e0   , 1e8   , "#mu vertex v_{x} [cm]"                      , "# events (2018)"   ),
  Histogram("LooseMuonsVertexSegmentMatch_vy"        , "", False, True  , default_norm              , 10 , -600  , 600   , 1e0   , 1e8   , "#mu vertex v_{y} [cm]"                      , "# events (2018)"   ),
  Histogram("LooseMuonsVertexSegmentMatch_vz"        , "", False, True  , default_norm              , 20 , -600  , 600   , 1e-1  , 1e8   , "#mu vertex v_{z} [cm]"                      , "# events (2018)"   ),
  Histogram("LooseMuonsVertexSegmentMatch_vxyz"      , "", False, True  , default_norm              , 20 , 0     , 800   , 1e-1  , 1e8   , "#mu vertex v_{xyz} [cm]"                    , "# events (2018)"   ),
  Histogram("LooseMuonsVertexSegmentMatch_dR"        , "", False, True  , default_norm              , 1  , 0     , 10    , 1e-1  , 1e8   , "#mu vertex #Delta R"                        , "# events (2018)"   ),
  Histogram("LooseMuonsVertexSegmentMatch_proxDR"    , "", False, True  , default_norm              , 1  , 0     , 10    , 1e-1  , 1e8   , "#mu vertex #Delta R"                        , "# events (2018)"   ),
  ...
  Histogram("Event_nLooseMuonsVertexSegmentMatch_PatDSA"               , "", False, True  , default_norm        , 1  , 0     , 20    , 1e1   , 1e6   , "Number of PAT-DSA #mu vertices"                 , "# events (2018)"   ),
  Histogram("LooseMuonsVertexSegmentMatch_vxy_PatDSA"                  , "", False, True  , default_norm        , 10 , 0     , 600   , 1e0   , 1e8   , "PAT-DSA #mu vertex v_{xy} [cm]"                 , "# events (2018)"   ),
  Histogram("LooseMuonsVertexSegmentMatch_vxySigma_PatDSA"             , "", False, True  , default_norm        , 2  , 0     , 100   , 1e-1  , 1e8   , "PAT-DSA #mu vertex #sigma_{v_{xy}} [cm]"        , "# events (2018)"   ),
  Histogram("LooseMuonsVertexSegmentMatch_vx_PatDSA"                   , "", False, True  , default_norm        , 10 , -600  , 600   , 1e0   , 1e8   , "PAT-DSA #mu vertex v_{x} [cm]"                  , "# events (2018)"   ),
  Histogram("LooseMuonsVertexSegmentMatch_vy_PatDSA"                   , "", False, True  , default_norm        , 10 , -600  , 600   , 1e0   , 1e8   , "PAT-DSA #mu vertex v_{y} [cm]"                  , "# events (2018)"   ),
  Histogram("LooseMuonsVertexSegmentMatch_vz_PatDSA"                   , "", False, True  , default_norm        , 20 , -600  , 600   , 1e-1  , 1e8   , "PAT-DSA #mu vertex v_{z} [cm]"                  , "# events (2018)"   ),
  Histogram("LooseMuonsVertexSegmentMatch_vxyz_PatDSA"                 , "", False, True  , default_norm        , 20 , 0     , 800   , 1e-1  , 1e8   , "PAT-DSA #mu vertex v_{xyz} [cm]"                , "# events (2018)"   ),
  Histogram("LooseMuonsVertexSegmentMatch_dR_PatDSA"                   , "", False, True  , default_norm        , 1  , 0     , 10    , 1e-1  , 1e8   , "PAT-DSA #mu vertex #Delta R"                    , "# events (2018)"   ),
  Histogram("LooseMuonsVertexSegmentMatch_chi2_PatDSA"                 , "", False, True  , default_norm        , 10 , 0     , 500   , 1e-1  , 1e8   , "PAT-DSA #mu vertex #chi^{2}"                    , "# events (2018)"   ),
  Histogram("Event_nLooseMuonsVertexSegmentMatch_Pat"                  , "", False, True  , default_norm        , 1  , 0     , 20    , 1e1   , 1e6   , "Number of PAT-DSA #mu vertices"                 , "# events (2018)"   ),
  Histogram("LooseMuonsVertexSegmentMatch_vxy_Pat"                     , "", False, True  , default_norm        , 10 , 0     , 600   , 1e0   , 1e8   , "PAT #mu vertex v_{xy} [cm]"                     , "# events (2018)"   ),
  Histogram("LooseMuonsVertexSegmentMatch_vxySigma_Pat"                , "", False, True  , default_norm        , 2  , 0     , 100   , 1e-1  , 1e8   , "PAT #mu vertex #sigma_{v_{xy}} [cm]"            , "# events (2018)"   ),
  Histogram("LooseMuonsVertexSegmentMatch_vx_Pat"                      , "", False, True  , default_norm        , 10 , -600  , 600   , 1e0   , 1e8   , "PAT #mu vertex v_{x} [cm]"                      , "# events (2018)"   ),
  Histogram("LooseMuonsVertexSegmentMatch_vy_Pat"                      , "", False, True  , default_norm        , 10 , -600  , 600   , 1e0   , 1e8   , "PAT #mu vertex v_{y} [cm]"                      , "# events (2018)"   ),
  Histogram("LooseMuonsVertexSegmentMatch_vz_Pat"                      , "", False, True  , default_norm        , 20 , -600  , 600   , 1e-1  , 1e8   , "PAT #mu vertex v_{z} [cm]"                      , "# events (2018)"   ),
  Histogram("LooseMuonsVertexSegmentMatch_vxyz_Pat"                    , "", False, True  , default_norm        , 20 , 0     , 800   , 1e-1  , 1e8   , "PAT #mu vertex v_{xyz} [cm]"                    , "# events (2018)"   ),
  Histogram("LooseMuonsVertexSegmentMatch_dR_Pat"                      , "", False, True  , default_norm        , 1  , 0     , 10    , 1e-1  , 1e8   , "PAT #mu vertex #Delta R"                        , "# events (2018)"   ),
  Histogram("LooseMuonsVertexSegmentMatch_chi2_Pat"                    , "", False, True  , default_norm        , 10 , 0     , 500   , 1e-1  , 1e8   , "PAT #mu vertex #chi^{2}"                        , "# events (2018)"   ),
  Histogram("Event_nLooseMuonsVertexSegmentMatch_DSA"                  , "", False, True  , default_norm        , 1  , 0     , 20    , 1e1   , 1e6   , "Number of PAT-DSA #mu vertices"                 , "# events (2018)"   ),
  Histogram("LooseMuonsVertexSegmentMatch_vxy_DSA"                     , "", False, True  , default_norm        , 10 , 0     , 600   , 1e0   , 1e8   , "DSA #mu vertex v_{xy} [cm]"                     , "# events (2018)"   ),
  Histogram("LooseMuonsVertexSegmentMatch_vxySigma_DSA"                , "", False, True  , default_norm        , 2  , 0     , 100   , 1e-1  , 1e8   , "DSA #mu vertex #sigma_{v_{xy}} [cm]"            , "# events (2018)"   ),
  Histogram("LooseMuonsVertexSegmentMatch_vx_DSA"                      , "", False, True  , default_norm        , 10 , -600  , 600   , 1e0   , 1e8   , "DSA #mu vertex v_{x} [cm]"                      , "# events (2018)"   ),
  Histogram("LooseMuonsVertexSegmentMatch_vy_DSA"                      , "", False, True  , default_norm        , 10 , -600  , 600   , 1e0   , 1e8   , "DSA #mu vertex v_{y} [cm]"                      , "# events (2018)"   ),
  Histogram("LooseMuonsVertexSegmentMatch_vz_DSA"                      , "", False, True  , default_norm        , 20 , -600  , 600   , 1e-1  , 1e8   , "DSA #mu vertex v_{z} [cm]"                      , "# events (2018)"   ),
  Histogram("LooseMuonsVertexSegmentMatch_vxyz_DSA"                    , "", False, True  , default_norm        , 20 , 0     , 800   , 1e-1  , 1e8   , "DSA #mu vertex v_{xyz} [cm]"                    , "# events (2018)"   ),
  Histogram("LooseMuonsVertexSegmentMatch_dR_DSA"                      , "", False, True  , default_norm        , 1  , 0     , 10    , 1e-1  , 1e8   , "DSA #mu vertex #Delta R"                        , "# events (2018)"   ),
  Histogram("LooseMuonsVertexSegmentMatch_chi2_DSA"                    , "", False, True  , default_norm        , 10 , 0     , 500   , 1e-1  , 1e8   , "DSA #mu vertex #chi^{2}"                        , "# events (2018)"   ),
  ...
  Histogram("LooseDSAMuons_PATOuterDR"           , "", False, True  , default_norm   , 1   , 0     , 1  , 1e-1    , 1e6 , "Outer #Delta R(loose DSA #mu, loose PAT #mu)"   , "# events (2018)"   ),
...
histograms_genALPs = (
  ...
  Histogram("GenMuonFromALP_looseMuonsMinDR"        , "", False, True  , default_norm          , 10  , 0     , 3     , 1e-2   , 1e6   , "#Delta R(Gen #mu, loose #mu)"                   , "# events (2018)"   ),
  ...
  Histogram("Event_nLooseMuonsFromALPDRMatch_DSA"        , "", False, True  , default_norm     , 1  , 0     , 15    , 1e-2*y_scale   , 1e9*y_scale   , "Number of loose DSA #mu from ALP"       , "# events (2018)"   ),
  Histogram("Event_nLooseMuonsFromALPDRMatch_PAT"        , "", False, True  , default_norm     , 1  , 0     , 15    , 1e-2*y_scale   , 1e9*y_scale   , "Number of loose PAT #mu from ALP"       , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPDRMatch_pt"                , "", False, True  , default_norm     , 20 , 0     , 500   , 1e-1  , 1e5   , "loose #mu from ALP p_{T} [GeV]"                          , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPDRMatch_eta"               , "", False, True  , default_norm     , 10 , -3    , 3     , 1e-1  , 1e5   , "loose #mu from ALP #eta"                                 , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPDRMatch_phi"               , "", False, True  , default_norm     , 10 , -3    , 3     , 1e-1  , 1e5   , "loose #mu from ALP #phi"                                 , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPDRMatch_dxy"               , "", False, True  , default_norm     , 20 , -200  , 200   , 1e-3  , 1e5   , "loose #mu from ALP d_{xy} [cm]"                          , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPDRMatch_dxyPVTraj"         , "", False, True  , default_norm     , 20 , -100  , 100   , 1e-3  , 1e5   , "loose #mu from ALP d_{xy} [cm]"                          , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPDRMatch_dxyPVTrajErr"      , "", False, True  , default_norm     , 20 , 0     , 200   , 1e-3  , 1e5   , "loose #mu from ALP d_{xy} uncertainty [cm]"              , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPDRMatch_dxyPVTrajSig"      , "", False, True  , default_norm     , 20 , 0     , 200   , 1e-3  , 1e5   , "loose #mu from ALP d_{xy} significance"                  , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPDRMatch_dz"                , "", False, True  , default_norm     , 20 , -200  , 200   , 1e-3  , 1e5   , "loose #mu from ALP d_{z} [cm]"                           , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPDRMatch_dzPV"              , "", False, True  , default_norm     , 20 , -200  , 200   , 1e-3  , 1e5   , "loose #mu from ALP d_{z} [cm]"                           , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPDRMatch_dzPVErr"           , "", False, True  , default_norm     , 20 , 0     , 200   , 1e-3  , 1e5   , "loose #mu from ALP d_{z} uncertainty [cm]"               , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPDRMatch_dzPVSig"           , "", False, True  , default_norm     , 20 , 0     , 200   , 1e-3  , 1e5   , "loose #mu from ALP d_{z} significance"                   , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPDRMatch_ip3DPVSigned"      , "", False, True  , default_norm     , 100, -500  , 500   , 1e-3  , 1e5   , "loose #mu from ALP 3D IP [cm]"                           , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPDRMatch_ip3DPVSignedErr"   , "", False, True  , default_norm     , 20 , 0     , 200   , 1e-3  , 1e5   , "loose #mu from ALP 3D IP uncertainty [cm]"               , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPDRMatch_ip3DPVSignedSig"   , "", False, True  , default_norm     , 20 , 0     , 200   , 1e-3  , 1e5   , "loose #mu from ALP 3D IP significance"                   , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPDRMatch_nSegments"         , "", False, True  , default_norm     , 10 , 0     , 10    , 1e-1  , 1e5   , "loose #mu from ALP number of segments"                   , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPDRMatch_invMass"           , "", False, True  , default_norm     , 10 , 0     , 10    , 1e-1  , 1e5   , "loose m_{#mu #mu} from ALP [GeV]"                        , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPDRMatch_deltaR"            , "", False, True  , default_norm     , 10 , 0     , 10    , 1e-1  , 1e5   , "loose #Delta R (#mu #mu) from ALP [GeV]"                 , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPDRMatch_outerDeltaR"       , "", False, True  , default_norm     , 10 , 0     , 10    , 1e-1  , 1e5   , "loose outer #Delta R (#mu #mu) from ALP [GeV]"           , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPDRMatch_deltaEta"          , "", False, True  , default_norm     , 10 , 0     , 10    , 1e-1  , 1e5   , "loose #Delta #eta (#mu #mu) from ALP [GeV]"              , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPDRMatch_deltaPhi"          , "", False, True  , default_norm     , 10 , 0     , 10    , 1e-1  , 1e5   , "loose #Delta #phi (#mu #mu) from ALP [GeV]"              , "# events (2018)"   ),
  ...
  Histogram("Event_nLooseMuonsFromALPOuterDRMatch_DSA"   , "", False, True  , default_norm     , 1  , 0     , 15    , 1e-2*y_scale   , 1e9*y_scale   , "Number of loose DSA #mu from ALP"       , "# events (2018)"   ),
  Histogram("Event_nLooseMuonsFromALPOuterDRMatch_PAT"   , "", False, True  , default_norm     , 1  , 0     , 15    , 1e-2*y_scale   , 1e9*y_scale   , "Number of loose PAT #mu from ALP"       , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPOuterDRMatch_pt"           , "", False, True  , default_norm     , 20 , 0     , 500   , 1e-1  , 1e5   , "loose #mu from ALP p_{T} [GeV]"                          , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPOuterDRMatch_eta"          , "", False, True  , default_norm     , 10 , -3    , 3     , 1e-1  , 1e5   , "loose #mu from ALP #eta"                                 , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPOuterDRMatch_phi"          , "", False, True  , default_norm     , 10 , -3    , 3     , 1e-1  , 1e5   , "loose #mu from ALP #phi"                                 , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPOuterDRMatch_dxy"          , "", False, True  , default_norm     , 20 , -200  , 200   , 1e-3  , 1e5   , "loose #mu from ALP d_{xy} [cm]"                          , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPOuterDRMatch_dxyPVTraj"    , "", False, True  , default_norm     , 20 , -100  , 100   , 1e-3  , 1e5   , "loose #mu from ALP d_{xy} [cm]"                          , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPOuterDRMatch_dxyPVTrajErr" , "", False, True  , default_norm     , 20 , 0     , 200   , 1e-3  , 1e5   , "loose #mu from ALP d_{xy} uncertainty [cm]"              , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPOuterDRMatch_dxyPVTrajSig" , "", False, True  , default_norm     , 20 , 0     , 200   , 1e-3  , 1e5   , "loose #mu from ALP d_{xy} significance"                  , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPOuterDRMatch_dz"           , "", False, True  , default_norm     , 20 , -200  , 200   , 1e-3  , 1e5   , "loose #mu from ALP d_{z} [cm]"                           , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPOuterDRMatch_dzPV"         , "", False, True  , default_norm     , 20 , -200  , 200   , 1e-3  , 1e5   , "loose #mu from ALP d_{z} [cm]"                           , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPOuterDRMatch_dzPVErr"      , "", False, True  , default_norm     , 20 , 0     , 200   , 1e-3  , 1e5   , "loose #mu from ALP d_{z} uncertainty [cm]"               , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPOuterDRMatch_dzPVSig"      , "", False, True  , default_norm     , 20 , 0     , 200   , 1e-3  , 1e5   , "loose #mu from ALP d_{z} significance"                   , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPOuterDRMatch_ip3DPVSigned"    , "", False, True  , default_norm  , 100, -500  , 500   , 1e-3  , 1e5   , "loose #mu from ALP 3D IP [cm]"                           , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPOuterDRMatch_ip3DPVSignedErr" , "", False, True  , default_norm  , 20 , 0     , 200   , 1e-3  , 1e5   , "loose #mu from ALP 3D IP uncertainty [cm]"               , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPOuterDRMatch_ip3DPVSignedSig" , "", False, True  , default_norm  , 20 , 0     , 200   , 1e-3  , 1e5   , "loose #mu from ALP 3D IP significance"                   , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPOuterDRMatch_nSegments"    , "", False, True  , default_norm     , 10 , 0     , 10    , 1e-1  , 1e5   , "loose #mu from ALP number of segments"                   , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPOuterDRMatch_invMass"      , "", False, True  , default_norm     , 10 , 0     , 10    , 1e-1  , 1e5   , "loose m_{#mu #mu} from ALP [GeV]"                        , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPOuterDRMatch_deltaR"       , "", False, True  , default_norm     , 10 , 0     , 10    , 1e-1  , 1e5   , "loose #Delta R (#mu #mu) from ALP [GeV]"                 , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPOuterDRMatch_outerDeltaR"  , "", False, True  , default_norm     , 10 , 0     , 10    , 1e-1  , 1e5   , "loose outer #Delta R (#mu #mu) from ALP [GeV]"           , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPOuterDRMatch_deltaEta"     , "", False, True  , default_norm     , 10 , 0     , 10    , 1e-1  , 1e5   , "loose #Delta #eta (#mu #mu) from ALP [GeV]"              , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPOuterDRMatch_deltaPhi"     , "", False, True  , default_norm     , 10 , 0     , 10    , 1e-1  , 1e5   , "loose #Delta #phi (#mu #mu) from ALP [GeV]"              , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPOuterDRMatch_minDeltaR"      , "", False, True  , default_norm     , 10 , 0     , 10    , 1e-1  , 1e5   , "loose min #Delta R (#mu #mu) from ALP [GeV]"             , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPOuterDRMatch_minOuterDeltaR" , "", False, True  , default_norm     , 10 , 0     , 10    , 1e-1  , 1e5   , "loose min outer #Delta R (#mu #mu) from ALP [GeV]"       , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPOuterDRMatch_minProxDeltaR"  , "", False, True  , default_norm     , 10 , 0     , 10    , 1e-1  , 1e5   , "loose min proximity #Delta R (#mu #mu) from ALP [GeV]"   , "# events (2018)"   ),
  
  Histogram("Event_nLooseMuonsFromALPSegmentMatch"       , "", False, True  , default_norm     , 1  , 0     , 15    , 1e-2*y_scale   , 1e9*y_scale   , "Number of loose #mu from ALP"           , "# events (2018)"   ),
  Histogram("Event_nLooseMuonsFromALPSegmentMatch_DSA"   , "", False, True  , default_norm     , 1  , 0     , 15    , 1e-2*y_scale   , 1e9*y_scale   , "Number of loose DSA #mu from ALP"       , "# events (2018)"   ),
  Histogram("Event_nLooseMuonsFromALPSegmentMatch_PAT"   , "", False, True  , default_norm     , 1  , 0     , 15    , 1e-2*y_scale   , 1e9*y_scale   , "Number of loose PAT #mu from ALP"       , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPSegmentMatch_pt"           , "", False, True  , default_norm     , 20 , 0     , 500   , 1e-1  , 1e5   , "loose #mu from ALP p_{T} [GeV]"                          , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPSegmentMatch_eta"          , "", False, True  , default_norm     , 10 , -3    , 3     , 1e-1  , 1e5   , "loose #mu from ALP #eta"                                 , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPSegmentMatch_phi"          , "", False, True  , default_norm     , 10 , -3    , 3     , 1e-1  , 1e5   , "loose #mu from ALP #phi"                                 , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPSegmentMatch_dxy"          , "", False, True  , default_norm     , 20 , -200  , 200   , 1e-3  , 1e5   , "loose #mu from ALP d_{xy} [cm]"                          , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPSegmentMatch_dxyPVTraj"    , "", False, True  , default_norm     , 20 , -100  , 100   , 1e-3  , 1e5   , "loose #mu from ALP d_{xy} [cm]"                          , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPSegmentMatch_dxyPVTrajErr" , "", False, True  , default_norm     , 20 , 0     , 200   , 1e-3  , 1e5   , "loose #mu from ALP d_{xy} uncertainty [cm]"              , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPSegmentMatch_dxyPVTrajSig" , "", False, True  , default_norm     , 20 , 0     , 200   , 1e-3  , 1e5   , "loose #mu from ALP d_{xy} significance"                  , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPSegmentMatch_dz"           , "", False, True  , default_norm     , 20 , -200  , 200   , 1e-3  , 1e5   , "loose #mu from ALP d_{z} [cm]"                           , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPSegmentMatch_dzPV"         , "", False, True  , default_norm     , 20 , -200  , 200   , 1e-3  , 1e5   , "loose #mu from ALP d_{z} [cm]"                           , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPSegmentMatch_dzPVErr"      , "", False, True  , default_norm     , 20 , 0     , 200   , 1e-3  , 1e5   , "loose #mu from ALP d_{z} uncertainty [cm]"               , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPSegmentMatch_dzPVSig"      , "", False, True  , default_norm     , 20 , 0     , 200   , 1e-3  , 1e5   , "loose #mu from ALP d_{z} significance"                   , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPSegmentMatch_ip3DPVSigned"    , "", False, True  , default_norm  , 100, -500  , 500   , 1e-3  , 1e5   , "loose #mu from ALP 3D IP [cm]"                           , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPSegmentMatch_ip3DPVSignedErr" , "", False, True  , default_norm  , 20 , 0     , 200   , 1e-3  , 1e5   , "loose #mu from ALP 3D IP uncertainty [cm]"               , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPSegmentMatch_ip3DPVSignedSig" , "", False, True  , default_norm  , 20 , 0     , 200   , 1e-3  , 1e5   , "loose #mu from ALP 3D IP significance"                   , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPSegmentMatch_nSegments"    , "", False, True  , default_norm     , 10 , 0     , 10    , 1e-1  , 1e5   , "loose #mu from ALP number of segments"                   , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPSegmentMatch_invMass"      , "", False, True  , default_norm     , 10 , 0     , 10    , 1e-1  , 1e5   , "loose m_{#mu #mu} from ALP [GeV]"                        , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPSegmentMatch_deltaR"       , "", False, True  , default_norm     , 10 , 0     , 10    , 1e-1  , 1e5   , "loose #Delta R (#mu #mu) from ALP [GeV]"                 , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPSegmentMatch_outerDeltaR"  , "", False, True  , default_norm     , 10 , 0     , 10    , 1e-1  , 1e5   , "loose outer #Delta R (#mu #mu) from ALP [GeV]"           , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPSegmentMatch_deltaEta"     , "", False, True  , default_norm     , 10 , 0     , 10    , 1e-1  , 1e5   , "loose #Delta #eta (#mu #mu) from ALP [GeV]"              , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPSegmentMatch_deltaPhi"     , "", False, True  , default_norm     , 10 , 0     , 10    , 1e-1  , 1e5   , "loose #Delta #phi (#mu #mu) from ALP [GeV]"              , "# events (2018)"   ),

  # Histogram("Event_nLooseMuonsFromALPDRMatchVertex"    , "", False, True  , default_norm              , 1  , 0     , 15    , 1e-2*y_scale  , 1e9*y_scale   , "Number of loose #mu from ALP vertices"                     , "# events (2018)"   ),
  # Histogram("LooseMuonsFromALPDRMatchVertex_vxy"       , "", False, True  , default_norm              , 50 , 0     , 500   , 1e0*y_scale   , 1e6*y_scale   , "Loose #mu from ALP vertex v_{xy} [cm]"                     , "# events (2018)"   ),
  # Histogram("LooseMuonsFromALPDRMatchVertex_vxySigma"  , "", False, True  , default_norm              , 2  , 0     , 100   , 1e0*y_scale   , 1e6*y_scale   , "Loose #mu from ALP vertex #sigma_{v_{xy}} [cm]"            , "# events (2018)"   ),
  # Histogram("LooseMuonsFromALPDRMatchVertex_vxyz"      , "", False, True  , default_norm              , 50 , 0     , 500   , 1e0*y_scale   , 1e6*y_scale   , "Loose #mu from ALP vertex v_{xyz} [cm]"                    , "# events (2018)"   ),
  # Histogram("LooseMuonsFromALPDRMatchVertex_vx"        , "", False, True  , default_norm              , 20 , -600  , 600   , 1e0*y_scale   , 1e6*y_scale   , "Loose #mu from ALP vertex v_{x} [cm]"                      , "# events (2018)"   ),
  # Histogram("LooseMuonsFromALPDRMatchVertex_vy"        , "", False, True  , default_norm              , 20 , -600  , 600   , 1e0*y_scale   , 1e6*y_scale   , "Loose #mu from ALP vertex v_{y} [cm]"                      , "# events (2018)"   ),
  # Histogram("LooseMuonsFromALPDRMatchVertex_vz"        , "", False, True  , default_norm              , 20 , -600  , 600   , 1e0*y_scale   , 1e6*y_scale   , "Loose #mu from ALP vertex v_{z} [cm]"                      , "# events (2018)"   ),
  # Histogram("LooseMuonsFromALPDRMatchVertex_dR"        , "", False, True  , default_norm              , 1  , 0     , 1     , 1e0*y_scale   , 1e6*y_scale   , "Loose #mu from ALP vertex #Delta R"                        , "# events (2018)"   ),
  # Histogram("LooseMuonsFromALPDRMatchVertex_proxDR"    , "", False, True  , default_norm              , 1  , 0     , 1     , 1e0*y_scale   , 1e6*y_scale   , "Loose #mu from ALP vertex #Delta R"                        , "# events (2018)"   ),
  # Histogram("LooseMuonsFromALPDRMatchVertex_chi2"      , "", False, True  , default_norm              , 2  , 0     , 100   , 1e0*y_scale   , 1e6*y_scale   , "Loose #mu from ALP vertex #chi^{2}"                        , "# events (2018)"   ),
  # Histogram("LooseMuonsFromALPDRMatchVertex_idx1"      , "", False, True  , default_norm              , 1  , 0     , 15    , 1e-2*y_scale  , 1e6*y_scale   , "#mu_{1} vertex index"                           , "# events (2018)"   ),
  # Histogram("LooseMuonsFromALPDRMatchVertex_idx2"      , "", False, True  , default_norm              , 1  , 0     , 15    , 1e-2*y_scale  , 1e6*y_scale   , "#mu_{2} vertex index"                           , "# events (2018)"   ),
  # Histogram("LooseMuonsFromALPDRMatchVertex_isDSAMuon1", "", False, True  , default_norm              , 1  , 0     , 2     , 1e-2*y_scale  , 1e6*y_scale   , "#mu_{1} == DSAMuon"                             , "# events (2018)"   ),
  # Histogram("LooseMuonsFromALPDRMatchVertex_isDSAMuon2", "", False, True  , default_norm              , 1  , 0     , 2     , 1e-2*y_scale  , 1e6*y_scale   , "#mu_{2} == DSAMuon"                             , "# events (2018)"   ),
  # Histogram("LooseMuonsFromALPDRMatchVertex_displacedTrackIso03Dimuon1"  , "", False, True  , default_norm        , 1  , 0     , 10    , 1e-1  , 1e7   , "Loose dimuon from ALP #mu_{1} displacedTrackIso03"         , "# events (2018)"   ),
  # Histogram("LooseMuonsFromALPDRMatchVertex_displacedTrackIso04Dimuon1"  , "", False, True  , default_norm        , 1  , 0     , 10    , 1e-1  , 1e7   , "Loose dimuon from ALP #mu_{1} displacedTrackIso04"         , "# events (2018)"   ),
  # Histogram("LooseMuonsFromALPDRMatchVertex_displacedTrackIso03Dimuon2"  , "", False, True  , default_norm        , 1  , 0     , 10    , 1e-1  , 1e7   , "Loose dimuon from ALP #mu_{2} displacedTrackIso03"         , "# events (2018)"   ),
  # Histogram("LooseMuonsFromALPDRMatchVertex_displacedTrackIso04Dimuon2"  , "", False, True  , default_norm        , 1  , 0     , 10    , 1e-1  , 1e7   , "Loose dimuon from ALP #mu_{2} displacedTrackIso04"         , "# events (2018)"   ),
  # Histogram("LooseMuonsFromALPDRMatchVertex_displacedTrackIso03Muon1"    , "", False, True  , default_norm        , 1  , 0     , 10    , 1e-1  , 1e7   , "Loose #mu_{1} from ALP displacedTrackIso03"                , "# events (2018)"   ),
  # Histogram("LooseMuonsFromALPDRMatchVertex_displacedTrackIso04Muon1"    , "", False, True  , default_norm        , 1  , 0     , 10    , 1e-1  , 1e7   , "Loose #mu_{1} from ALP displacedTrackIso04"                , "# events (2018)"   ),
  # Histogram("LooseMuonsFromALPDRMatchVertex_displacedTrackIso03Muon2"    , "", False, True  , default_norm        , 1  , 0     , 10    , 1e-1  , 1e7   , "Loose #mu_{2} from ALP displacedTrackIso03"                , "# events (2018)"   ),
  # Histogram("LooseMuonsFromALPDRMatchVertex_displacedTrackIso04Muon2"    , "", False, True  , default_norm        , 1  , 0     , 10    , 1e-1  , 1e7   , "Loose #mu_{2} from ALP displacedTrackIso04"                , "# events (2018)"   ),
  
  Histogram("Event_nLooseMuonsFromALPOuterDRMatchVertex"    , "", False, True  , default_norm              , 1  , 0     , 15    , 1e-2*y_scale  , 1e9*y_scale   , "Number of loose #mu from ALP vertices"                     , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPOuterDRMatchVertex_vxy"       , "", False, True  , default_norm              , 50 , 0     , 500   , 1e0*y_scale   , 1e6*y_scale   , "Loose #mu from ALP vertex v_{xy} [cm]"                     , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPOuterDRMatchVertex_vxySigma"  , "", False, True  , default_norm              , 2  , 0     , 100   , 1e0*y_scale   , 1e6*y_scale   , "Loose #mu from ALP vertex #sigma_{v_{xy}} [cm]"            , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPOuterDRMatchVertex_vxyz"      , "", False, True  , default_norm              , 50 , 0     , 500   , 1e0*y_scale   , 1e6*y_scale   , "Loose #mu from ALP vertex v_{xyz} [cm]"                    , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPOuterDRMatchVertex_vx"        , "", False, True  , default_norm              , 20 , -600  , 600   , 1e0*y_scale   , 1e6*y_scale   , "Loose #mu from ALP vertex v_{x} [cm]"                      , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPOuterDRMatchVertex_vy"        , "", False, True  , default_norm              , 20 , -600  , 600   , 1e0*y_scale   , 1e6*y_scale   , "Loose #mu from ALP vertex v_{y} [cm]"                      , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPOuterDRMatchVertex_vz"        , "", False, True  , default_norm              , 20 , -600  , 600   , 1e0*y_scale   , 1e6*y_scale   , "Loose #mu from ALP vertex v_{z} [cm]"                      , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPOuterDRMatchVertex_dR"        , "", False, True  , default_norm              , 1  , 0     , 1     , 1e0*y_scale   , 1e6*y_scale   , "Loose #mu from ALP vertex #Delta R"                        , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPOuterDRMatchVertex_proxDR"    , "", False, True  , default_norm              , 1  , 0     , 1     , 1e0*y_scale   , 1e6*y_scale   , "Loose #mu from ALP vertex #Delta R"                        , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPOuterDRMatchVertex_chi2"      , "", False, True  , default_norm              , 2  , 0     , 100   , 1e0*y_scale   , 1e6*y_scale   , "Loose #mu from ALP vertex #chi^{2}"                        , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPOuterDRMatchVertex_idx1"      , "", False, True  , default_norm              , 1  , 0     , 15    , 1e-2*y_scale  , 1e6*y_scale   , "#mu_{1} vertex index"                           , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPOuterDRMatchVertex_idx2"      , "", False, True  , default_norm              , 1  , 0     , 15    , 1e-2*y_scale  , 1e6*y_scale   , "#mu_{2} vertex index"                           , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPOuterDRMatchVertex_isDSAMuon1", "", False, True  , default_norm              , 1  , 0     , 2     , 1e-2*y_scale  , 1e6*y_scale   , "#mu_{1} == DSAMuon"                             , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPOuterDRMatchVertex_isDSAMuon2", "", False, True  , default_norm              , 1  , 0     , 2     , 1e-2*y_scale  , 1e6*y_scale   , "#mu_{2} == DSAMuon"                             , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPOuterDRMatchVertex_displacedTrackIso03Dimuon1"  , "", False, True  , default_norm        , 1  , 0     , 10    , 1e-1  , 1e7   , "Loose dimuon from ALP #mu_{1} displacedTrackIso03"         , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPOuterDRMatchVertex_displacedTrackIso04Dimuon1"  , "", False, True  , default_norm        , 1  , 0     , 10    , 1e-1  , 1e7   , "Loose dimuon from ALP #mu_{1} displacedTrackIso04"         , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPOuterDRMatchVertex_displacedTrackIso03Dimuon2"  , "", False, True  , default_norm        , 1  , 0     , 10    , 1e-1  , 1e7   , "Loose dimuon from ALP #mu_{2} displacedTrackIso03"         , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPOuterDRMatchVertex_displacedTrackIso04Dimuon2"  , "", False, True  , default_norm        , 1  , 0     , 10    , 1e-1  , 1e7   , "Loose dimuon from ALP #mu_{2} displacedTrackIso04"         , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPOuterDRMatchVertex_displacedTrackIso03Muon1"    , "", False, True  , default_norm        , 1  , 0     , 10    , 1e-1  , 1e7   , "Loose #mu_{1} from ALP displacedTrackIso03"                , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPOuterDRMatchVertex_displacedTrackIso04Muon1"    , "", False, True  , default_norm        , 1  , 0     , 10    , 1e-1  , 1e7   , "Loose #mu_{1} from ALP displacedTrackIso04"                , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPOuterDRMatchVertex_displacedTrackIso03Muon2"    , "", False, True  , default_norm        , 1  , 0     , 10    , 1e-1  , 1e7   , "Loose #mu_{2} from ALP displacedTrackIso03"                , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPOuterDRMatchVertex_displacedTrackIso04Muon2"    , "", False, True  , default_norm        , 1  , 0     , 10    , 1e-1  , 1e7   , "Loose #mu_{2} from ALP displacedTrackIso04"                , "# events (2018)"   ),

  Histogram("Event_nLooseMuonsFromALPSegmentMatchVertex"    , "", False, True  , default_norm              , 1  , 0     , 15    , 1e-2*y_scale  , 1e9*y_scale   , "Number of loose #mu from ALP vertices"                     , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPSegmentMatchVertex_vxy"       , "", False, True  , default_norm              , 50 , 0     , 500   , 1e0*y_scale   , 1e6*y_scale   , "Loose #mu from ALP vertex v_{xy} [cm]"                     , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPSegmentMatchVertex_vxySigma"  , "", False, True  , default_norm              , 2  , 0     , 100   , 1e0*y_scale   , 1e6*y_scale   , "Loose #mu from ALP vertex #sigma_{v_{xy}} [cm]"            , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPSegmentMatchVertex_vxyz"      , "", False, True  , default_norm              , 50 , 0     , 500   , 1e0*y_scale   , 1e6*y_scale   , "Loose #mu from ALP vertex v_{xyz} [cm]"                    , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPSegmentMatchVertex_vx"        , "", False, True  , default_norm              , 20 , -600  , 600   , 1e0*y_scale   , 1e6*y_scale   , "Loose #mu from ALP vertex v_{x} [cm]"                      , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPSegmentMatchVertex_vy"        , "", False, True  , default_norm              , 20 , -600  , 600   , 1e0*y_scale   , 1e6*y_scale   , "Loose #mu from ALP vertex v_{y} [cm]"                      , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPSegmentMatchVertex_vz"        , "", False, True  , default_norm              , 20 , -600  , 600   , 1e0*y_scale   , 1e6*y_scale   , "Loose #mu from ALP vertex v_{z} [cm]"                      , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPSegmentMatchVertex_dR"        , "", False, True  , default_norm              , 1  , 0     , 1     , 1e0*y_scale   , 1e6*y_scale   , "Loose #mu from ALP vertex #Delta R"                        , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPSegmentMatchVertex_proxDR"    , "", False, True  , default_norm              , 1  , 0     , 1     , 1e0*y_scale   , 1e6*y_scale   , "Loose #mu from ALP vertex #Delta R"                        , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPSegmentMatchVertex_chi2"      , "", False, True  , default_norm              , 2  , 0     , 100   , 1e0*y_scale   , 1e6*y_scale   , "Loose #mu from ALP vertex #chi^{2}"                        , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPSegmentMatchVertex_idx1"      , "", False, True  , default_norm              , 1  , 0     , 15    , 1e-2*y_scale  , 1e6*y_scale   , "#mu_{1} vertex index"                           , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPSegmentMatchVertex_idx2"      , "", False, True  , default_norm              , 1  , 0     , 15    , 1e-2*y_scale  , 1e6*y_scale   , "#mu_{2} vertex index"                           , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPSegmentMatchVertex_isDSAMuon1", "", False, True  , default_norm              , 1  , 0     , 2     , 1e-2*y_scale  , 1e6*y_scale   , "#mu_{1} == DSAMuon"                             , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPSegmentMatchVertex_isDSAMuon2", "", False, True  , default_norm              , 1  , 0     , 2     , 1e-2*y_scale  , 1e6*y_scale   , "#mu_{2} == DSAMuon"                             , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPSegmentMatchVertex_displacedTrackIso03Dimuon1"  , "", False, True  , default_norm        , 1  , 0     , 10    , 1e-1  , 1e7   , "Loose dimuon from ALP #mu_{1} displacedTrackIso03"         , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPSegmentMatchVertex_displacedTrackIso04Dimuon1"  , "", False, True  , default_norm        , 1  , 0     , 10    , 1e-1  , 1e7   , "Loose dimuon from ALP #mu_{1} displacedTrackIso04"         , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPSegmentMatchVertex_displacedTrackIso03Dimuon2"  , "", False, True  , default_norm        , 1  , 0     , 10    , 1e-1  , 1e7   , "Loose dimuon from ALP #mu_{2} displacedTrackIso03"         , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPSegmentMatchVertex_displacedTrackIso04Dimuon2"  , "", False, True  , default_norm        , 1  , 0     , 10    , 1e-1  , 1e7   , "Loose dimuon from ALP #mu_{2} displacedTrackIso04"         , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPSegmentMatchVertex_displacedTrackIso03Muon1"    , "", False, True  , default_norm        , 1  , 0     , 10    , 1e-1  , 1e7   , "Loose #mu_{1} from ALP displacedTrackIso03"                , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPSegmentMatchVertex_displacedTrackIso04Muon1"    , "", False, True  , default_norm        , 1  , 0     , 10    , 1e-1  , 1e7   , "Loose #mu_{1} from ALP displacedTrackIso04"                , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPSegmentMatchVertex_displacedTrackIso03Muon2"    , "", False, True  , default_norm        , 1  , 0     , 10    , 1e-1  , 1e7   , "Loose #mu_{2} from ALP displacedTrackIso03"                , "# events (2018)"   ),
  Histogram("LooseMuonsFromALPSegmentMatchVertex_displacedTrackIso04Muon2"    , "", False, True  , default_norm        , 1  , 0     , 10    , 1e-1  , 1e7   , "Loose #mu_{2} from ALP displacedTrackIso04"                , "# events (2018)"   ),
)
