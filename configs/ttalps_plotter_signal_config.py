...
#           name                                  title logy    norm_type                 rebin xmin   xmax    ymin    ymax,   xlabel                                             ylabel
  ...
  Histogram("LooseMuons_pt"                       , "", True  , default_norm              , 1  , 0     , 50    , 1e-2  , 1e6   , "loose #mu p_{T} [GeV]"                          , "# events (2018)"   ),
  Histogram("LooseMuons_leadingPt"                , "", True  , default_norm              , 1  , 0     , 50    , 1e-2  , 1e6   , "leading loose #mu p_{T} [GeV]"                  , "# events (2018)"   ),
  ...
  Histogram("LooseMuons_dxy"                      , "", True  , default_norm              , 20 , -400  , 400   , 1e-2  , 1e6   , "loose #mu d_{xy} [cm]"                          , "# events (2018)"   ),
  Histogram("LooseMuons_dz"                       , "", True  , default_norm              , 20 , -400  , 400   , 1e-2  , 1e6   , "loose #mu d_{z} [cm]"                           , "# events (2018)"   ),
...
#           name                                  title logy    norm_type                 rebin xmin   xmax    ymin    ymax,   xlabel                                             ylabel
  ...
  Histogram("LooseDSAMuons_dxy"                   , "", True  , default_norm              , 20 , -400  , 400   , 1e-2  , 1e6   , "loose dSA #mu d_{xy} [cm]"                      , "# events (2018)"   ),
  Histogram("LooseDSAMuons_dz"                    , "", True  , default_norm              , 20 , -400  , 400   , 1e-2  , 1e6   , "loose dSA #mu d_{z} [cm]"                       , "# events (2018)"   ),
  ...
  Histogram("AllLooseMuons_dxy"                   , "", True  , default_norm              , 20 , -400  , 400   , 1e-2  , 1e6   , "loose #mu d_{xy} [cm]"                          , "# events (2018)"   ),
  Histogram("AllLooseMuons_dz"                    , "", True  , default_norm              , 20 , -400  , 400   , 1e-2  , 1e6   , "loose #mu d_{z} [cm]"                           , "# events (2018)"   ),
