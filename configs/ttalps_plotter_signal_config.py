...
#           name                                  title logy    norm_type                 rebin xmin   xmax    ymin    ymax,   xlabel                                             ylabel
  ...
  Histogram("LooseDSAMuons_muonMatch1"           , "", False, True  , default_norm   , 1  , 0     , 10    , 1e-1    , 1e7 , "number of muon matches"          , "# events (2018)"   ),
...
for method in muonMatchingMethods:
  for category in muonCategories:
    ...
    LLPnanoAOD_histograms += (
      Histogram("Event_n"+collectionName          , "", False, True  , default_norm              , 1  , 0     , 15    , 1e-2*y_scale   , 1e9*y_scale   , "Number of loose #mu"           , "# events (2018)"   ),
      Histogram(collectionName+"_pt"              , "", False, True  , default_norm              , 20 , 0     , 500   , 1e-1  , 1e5   , "loose #mu p_{T} [GeV]"                          , "# events (2018)"   ),
      ...
      Histogram(collectionName+"_minDeltaR"       , "", False, True  , default_norm              , 10 , 0     , 6     , 1e-1  , 1e8   , "min #Delta R(loose #mu, loose #mu)"              , "# events (2018)"   ),
      Histogram(collectionName+"_minOuterDeltaR"  , "", False, True  , default_norm              , 10 , 0     , 6     , 1e-1  , 1e8   , "min outer #Delta R(loose #mu, loose #mu)"        , "# events (2018)"   ),
      Histogram(collectionName+"_minProxDeltaR"   , "", False, True  , default_norm              , 10 , 0     , 6     , 1e-1  , 1e8   , "min proximity #Delta R(loose #mu, loose #mu)"    , "# events (2018)"   ),
    )
  vertexCollectionName = "LooseMuons"+method+"MatchVertex"
  Histogram("LooseMuonsVertexSegmentMatch_vxErr"     , "", False, True  , default_norm              , 10 , -600  , 600   , 1e0   , 1e8   , "#mu vertex #sigma_{v_{x}} [cm]"                      , "# events (2018)"   ),
  Histogram("LooseMuonsVertexSegmentMatch_vyErr"     , "", False, True  , default_norm              , 10 , -600  , 600   , 1e0   , 1e8   , "#mu vertex #sigma_{v_{y}} [cm]"                      , "# events (2018)"   ),
  Histogram("LooseMuonsVertexSegmentMatch_vzErr"     , "", False, True  , default_norm              , 20 , -600  , 600   , 1e-1  , 1e8   , "#mu vertex #sigma_{v_{z}} [cm]"                      , "# events (2018)"   ),
  ...
  Histogram("LooseMuonsVertexSegmentMatch_displacedTrackIso03Dimuon1"  , "", False, True  , default_norm        , 1  , 0     , 10    , 1e-1  , 1e7   , "dimuon #mu_{1} displacedTrackIso03"         , "# events (2018)"   ),
  Histogram("LooseMuonsVertexSegmentMatch_displacedTrackIso04Dimuon1"  , "", False, True  , default_norm        , 1  , 0     , 10    , 1e-1  , 1e7   , "dimuon #mu_{1} displacedTrackIso04"         , "# events (2018)"   ),
  Histogram("LooseMuonsVertexSegmentMatch_displacedTrackIso03Dimuon2"  , "", False, True  , default_norm        , 1  , 0     , 10    , 1e-1  , 1e7   , "dimuon #mu_{2} displacedTrackIso03"         , "# events (2018)"   ),
  Histogram("LooseMuonsVertexSegmentMatch_displacedTrackIso04Dimuon2"  , "", False, True  , default_norm        , 1  , 0     , 10    , 1e-1  , 1e7   , "dimuon #mu_{2} displacedTrackIso04"         , "# events (2018)"   ),
  Histogram("LooseMuonsVertexSegmentMatch_displacedTrackIso03Muon1"    , "", False, True  , default_norm        , 1  , 0     , 10    , 1e-1  , 1e7   , "#mu_{1} displacedTrackIso03"                , "# events (2018)"   ),
  Histogram("LooseMuonsVertexSegmentMatch_displacedTrackIso04Muon1"    , "", False, True  , default_norm        , 1  , 0     , 10    , 1e-1  , 1e7   , "#mu_{1} displacedTrackIso04"                , "# events (2018)"   ),
  Histogram("LooseMuonsVertexSegmentMatch_displacedTrackIso03Muon2"    , "", False, True  , default_norm        , 1  , 0     , 10    , 1e-1  , 1e7   , "#mu_{2} displacedTrackIso03"                , "# events (2018)"   ),
  Histogram("LooseMuonsVertexSegmentMatch_displacedTrackIso04Muon2"    , "", False, True  , default_norm        , 1  , 0     , 10    , 1e-1  , 1e7   , "#mu_{2} displacedTrackIso04"                , "# events (2018)"   ),
  
  for category in muonVertexCategories:
    vertexCollectionName = "LooseMuons"+method+"MatchVertex"
    Histogram("Event_n"+vertexCollectionName+category               , "", False, True  , default_norm        , 1  , 0     , 20    , 1e1   , 1e6   , "Number of #mu vertices"                 , "# events (2018)"   ),
    Histogram(vertexCollectionName+"_vxy"+category                  , "", False, True  , default_norm        , 10 , 0     , 600   , 1e0   , 1e8   , "#mu vertex v_{xy} [cm]"                 , "# events (2018)"   ),
    Histogram(vertexCollectionName+"_vxySigma"+category             , "", False, True  , default_norm        , 2  , 0     , 100   , 1e-1  , 1e8   , "#mu vertex #sigma_{v_{xy}} [cm]"        , "# events (2018)"   ),
    Histogram(vertexCollectionName+"_vx"+category                   , "", False, True  , default_norm        , 10 , -600  , 600   , 1e0   , 1e8   , "#mu vertex v_{x} [cm]"                  , "# events (2018)"   ),
    Histogram(vertexCollectionName+"_vy"+category                   , "", False, True  , default_norm        , 10 , -600  , 600   , 1e0   , 1e8   , "#mu vertex v_{y} [cm]"                  , "# events (2018)"   ),
    Histogram(vertexCollectionName+"_vz"+category                   , "", False, True  , default_norm        , 20 , -600  , 600   , 1e-1  , 1e8   , "#mu vertex v_{z} [cm]"                  , "# events (2018)"   ),
    Histogram(vertexCollectionName+"_vxyz"+category                 , "", False, True  , default_norm        , 20 , 0     , 800   , 1e-1  , 1e8   , "#mu vertex v_{xyz} [cm]"                , "# events (2018)"   ),
    Histogram(vertexCollectionName+"_dR"+category                   , "", False, True  , default_norm        , 1  , 0     , 10    , 1e-1  , 1e8   , "#mu vertex #Delta R"                    , "# events (2018)"   ),
    Histogram(vertexCollectionName+"_chi2"+category                 , "", False, True  , default_norm        , 10 , 0     , 500   , 1e-1  , 1e8   , "#mu vertex #chi^{2}"                    , "# events (2018)"   ),
...
for method in muonMatchingMethods:
  ...
  histograms_genALPs += (
    ...
    Histogram(collectionName+"Vertex_vxy"       , "", False, True  , default_norm              , 50 , 0     , 500   , 1e0*y_scale   , 1e6*y_scale   , "Loose #mu from ALP vertex v_{xy} [cm]"                     , "# events (2018)"   ),
    Histogram(collectionName+"Vertex_vxySigma"  , "", False, True  , default_norm              , 2  , 0     , 100   , 1e0*y_scale   , 1e6*y_scale   , "Loose #mu from ALP vertex #sigma_{v_{xy}} [cm]"            , "# events (2018)"   ),
    Histogram(collectionName+"Vertex_vxyz"      , "", False, True  , default_norm              , 50 , 0     , 500   , 1e0*y_scale   , 1e6*y_scale   , "Loose #mu from ALP vertex v_{xyz} [cm]"                    , "# events (2018)"   ),
    ...
    Histogram(collectionName+"Vertex_chi2"      , "", False, True  , default_norm              , 2  , 0     , 100   , 1e0*y_scale   , 1e6*y_scale   , "Loose #mu from ALP vertex #chi^{2}"                        , "# events (2018)"   ),
    Histogram(collectionName+"Vertex_idx1"      , "", False, True  , default_norm              , 1  , 0     , 15    , 1e-2*y_scale  , 1e6*y_scale   , "#mu_{1} vertex index"                           , "# events (2018)"   ),
    Histogram(collectionName+"Vertex_idx2"      , "", False, True  , default_norm              , 1  , 0     , 15    , 1e-2*y_scale  , 1e6*y_scale   , "#mu_{2} vertex index"                           , "# events (2018)"   ),
