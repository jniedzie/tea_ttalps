...
def get_luminosity_uncertainty_correlated2016to2018(year):
  ...
  if year in uncertainties and uncertainties[year] != 0:
    ...
    error(f"2016-2018 correlated luminosity uncertainty for year {year} is not defined. Luminosity uncertainty set to 1.")
    return 1.
...
def get_luminosity_uncertainty_correlated2017to2018(year):
  ...
  if year in uncertainties and uncertainties[year] != 0:
    ...
    error(f"2017-2018 correlated luminosity uncertainty for year {year} is not defined. Luminosity uncertainty set to 1.")
    return 1.
